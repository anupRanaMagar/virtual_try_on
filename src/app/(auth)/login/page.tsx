    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-100">
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="space-y-4">
          ...
          <button
            className="w-full flex items-center justify-center px-4 py-2  text-white rounded-3xl border hover:bg-slate-200"
          ...
          >
            ...
            <span className="ml-2 text-black">Continue with Github</span>
          </button>
        </div>
